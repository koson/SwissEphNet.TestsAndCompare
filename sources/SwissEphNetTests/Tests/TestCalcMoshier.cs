...
{
    [Export(typeof(ITest))]
    public class TestCalcMoshier : BaseTest
    {
        public TestCalcMoshier()
        {
            Title = "Test planet calculation with Moshier ephemeris";
            Description = "Test the planet calculations with the Moshier ephemeris";
        }

        protected override void RunTest(ResultTestValues result, ISwephProvider provider)
        {
            int iflag = SwephDll.SEFLG_MOSEPH;
